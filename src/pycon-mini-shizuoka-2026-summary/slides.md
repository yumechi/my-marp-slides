...
- 2026/02/21(土) 10:00-18:00
- 静岡県静岡市葵区御幸町3番地の21 ペガサート7階
    - メイン会場: 静岡市 コ・クリエーションスペース
    - セッション会場: B-nest（ビネスト） 静岡市産学交流センター・静岡市中小企業支援センター
- 8つのトーク, 1つのキーノート, LT, ブース出展, etc...
...
- 開催後公式パーティがあります
- Connpass サブイベントから参加できます
- https://pycon-shizu.connpass.com/event/380926/
- **学生向けは割引あります！** ご活用ください<br>https://pycon-shizu.connpass.com/event/381604/
